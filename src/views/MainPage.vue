<template>
  <div class="h-screen bg-gradient-to-b from-start from-0% to-end to-90%">
    <div class="max-w-full mx-auto p-6 text-white text-center h-auto flex flex-col justify-between relative">
      <!-- 배경 이미지 -->
    ...
    <div class="z-10 px-5 pt-8 pb-14 relative bg-white rounded-tl-2xl rounded-tr-2xl shadow-[0px_-8px_12px_0px_rgba(0,0,0,0.08)] flex flex-col justify-center items-center gap-14">
